                                        ...
                                        {	
                                            ...
                                            {	
                                                ...
                                                {	
                                                    ...
                                                    $response["message"] = "Existen registros.";
                                                    $dependencia3 = '';
                                                    $result = pg_query($conn, "SELECT wcrear_control('1', 'div', 'col-sm-6', '$dependencia1', '', '', '2', '$perfil1')");
                                                    if(pg_num_rows($result) > 0)
                                                    {	
                                                        $response["resultado"] = array();
                                                        while ($row = pg_fetch_array($result)) {
                                                        ...
                                                        $response["message"] = "Existen registros.";
                                                        //echo json_encode($response);
                                                        $dependencia3 = $response["resultado"][0]["wcrear_control"];
                                                        $result1 = pg_query($conn, "SELECT wcrear_control('1', 'p', '', '$dependencia3', 'Lorem ipsum Pregunta', '', '1', '$perfil1')");
                                                        $result1 = pg_query($conn, "SELECT wcrear_control('1', 'div', 'form-group clearfix', '$dependencia3', '', '', '2', '$perfil1')");
                                                        if(pg_num_rows($result1) > 0)
                                                        {	
                                                            $response["resultado"] = array();
                                                            while ($row = pg_fetch_array($result1)) {
                                                            ...
                                                            $response["message"] = "Existen registros.";
                                                            $dependencia3 = $response["resultado"][0]["wcrear_control"];
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'p', '', '$dependencia3', 'Fecha inicial', '', '2', '$perfil1')");
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'input', 'form-control', '$dependencia3', '', 'date', '3', '$perfil1')");
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'p', '', '$dependencia3', 'Fecha final', '', '4', '$perfil1')");
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'input', 'form-control', '$dependencia3', '', 'date', '5', '$perfil1')");
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'p', '', '$dependencia3', 'Observación', '', '6', '$perfil1')");
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'textarea', 'form-control', '$dependencia3', '', '', '7', '$perfil1')");
                                                            $result1 = pg_query($conn, "SELECT wcrear_control('1', 'div', 'icheck-primary d-inline', '$dependencia3', '', '', '1', '$perfil1')");
                                                            if(pg_num_rows($result1) > 0)
                                                            {	
                                                                $response["resultado"] = array();
                                                                while ($row = pg_fetch_array($result1)) {
                                                                ...
                                                                $response["message"] = "Existen registros.";
                                                                $dependencia3 = $response["resultado"][0]["wcrear_control"];
                                                                $result1 = pg_query($conn, "SELECT wcrear_control('1', 'input', '', '$dependencia3', 'SI', 'radio', '1', '$perfil1')");
                                                                $result1 = pg_query($conn, "SELECT wcrear_control('1', 'input', '', '$dependencia3', 'NO', 'radio', '2', '$perfil1')");
                                                                if(pg_num_rows($result1) > 0)
                                                                {	
                                                                    $response["resultado"] = array();
                                                                    while ($row = pg_fetch_array($result1)) {
